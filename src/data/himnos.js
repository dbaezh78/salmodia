// db.Himno Pascua Semana 1, Jueves - Laudes - Octaba de Pascua
// Himno Oficio de Lectura
const htps1jsOft = "Himno: OH REY PERPETUO DE LOS ELEGIDOS"
const htps1jsOf = `Oh Rey perpetuo de los elegidos,
...
// Himno Laudes
const htps1jsLAt = "Himno: EL AGUA PURA, DON DE LA MAÑANA"
const htps1jsLA = `El agua pura, don de la mañana,
...
// Himno Tercia
const htps1jsTrt = "Himno: AL SEÑOR CONFESAMOS, ¡ALELUYA!"
const htps1jsTr = `Al Señor confesamos, ¡aleluya!
...
// Himno Sexta
const htps1jsSxt = "Himno: VERBO DE DIOS, EL SOL DE MEDIODÍA"
const htps1jsSx = `Verbo de Dios, el sol de mediodía,
...
const htps1jsNnt = "Himno: REINA EL SEÑOR ALLÍ DONDE NINGUNO"
const htps1jsNn = `Reina el Señor allí donde ninguno
...
const htps1jsVst = "Himno: ES LA PASCUA REAL, NO YA LA SOMBRA."
const htps1jsVs = `Es la Pascua real, no ya la sombra,
...
const htps1jsCmt = "Himno: EL CORAZÓN SE DILATA"
const htps1jsCm = `El corazón se dilata
