...
const tos1LAdm_lbt = "Is 61, 1-2a"
const tos1LAdm_lb = `El Espíritu del Señor está sobre mí, porque el Señor me ha ungido. Me ha enviado para dar la buena noticia a los pobres, para vendar los corazones desgarrados, para proclamar la amnistía a los cautivos, la libertad a los prisioneros, para proclamar el año de gracia del Señor.`
const tos1LAdm_rb = "Cristo, Hijo de Dios vivo, ten piedad de nosotros."
const tos1LAdm_rb1 = "Tú que hoy te has manifestado."
const tos1LAdm_rb2 = "Ten piedad de nosotros."

// Tiempo Ordinario Semana 2 Laudes DOMINGO
const tos2LAdm_lbt ="Ez 36, 25-27"
const tos2LAdm_lb ="Derramaré sobre vosotros un agua pura que os purificará: de todas vuestras inmundicias e idolatrías os he de purificar; y os daré un corazón nuevo, y os infundiré un espíritu nuevo; arrancaré de vuestra carne el corazón de piedra, y os daré un corazón de carne. Os infundiré mi espíritu, y haré que caminéis según mis preceptos, y que guardéis y cumpláis mis mandatos."
const tos2LAdm_rb = "Te damos gracias, ¡oh Dios!, invocando tu nombre."
const tos2LAdm_rb1 = "Pregonando tus maravillas."
const tos2LAdm_rb2 = "Invocando tu nombre."

// Tiempo Ordinario Semana 3 Laudes DOMINGO
const tos3LAdm_lbt ="Ez 37, 12b-14"
const tos3LAdm_lb ="Así dice el Señor. «Yo mismo abriré vuestros sepulcros, y os haré salir de vuestros sepulcros, pueblo mío, y os traeré a la tierra de Israel. Y cuando abra vuestros sepulcros y os saque de vuestros sepulcros, pueblo mío, sabréis que yo soy el Señor: os infundiré mi espíritu y viviréis, os colocaré en vuestra tierra y sabréis que yo el Señor lo digo y lo hago.» Oráculo del Señor."
const tos3LAdm_rb = "Cristo, Hijo de Dios vivo, ten piedad de nosotros."
const tos3LAdm_rb1 = "Tú que estás sentado a la derecha del Padre."
const tos3LAdm_rb2 = "Ten piedad de nosotros."

const tos4LAdm_lbt = "2Tm 2, 8. 11-13"
const tos4LAdm_lb = "Acuérdate de Cristo Jesús, del linaje de David, que vive resucitado de entre los muertos. Verdadera es la sentencia que dice: Si hemos muerto con él, viviremos también con él. Si tenemos constancia en el sufrir, reinaremos también con él; si rehusamos reconocerle, también él nos rechazará; si le somos infieles, él permanece fiel; no puede él desmentirse a sí mismo."
const tos4LAdm_rb = "Te damos gracias, ¡oh Dios!, invocando tu nombre."
const tos4LAdm_rb1 = "Pregonando tus maravillas."
const tos4LAdm_rb2 = "Invocando tu nombre."

const tos5LAdm_lbt = "Ap 7, 10. 12"
const tos5LAdm_lb = "¡La salvación es de nuestro Dios, que está sentado en el trono, y del Cordero! La bendición, y la gloria, y la sabiduría, y la acción de gracias, y el honor, y el poder, y la fuerza son de nuestro Dios por los siglos de los siglos. Amén."
const tos5LAdm_rb = "Cristo, Hijo de Dios vivo, ten piedad de nosotros."
const tos5LAdm_rb1 = "Tú que estás sentado a la derecha del Padre."
const tos5LAdm_rb2 = "Ten piedad de nosotros."

const tos6LAdm_lbt = "2Pe 1, 10-11"
const tos6LAdm_lb = "Hermanos, poned más empeño todavía en consolidar vuestra vocación y elección. Si hacéis así, nunca jamás tropezaréis; de este modo se os concederá generosamente la entrada en el reino eterno de nuestro Señor y salvador Jesucristo."
const tos6LAdm_rb = "A ti grito, Señor, tú eres mi refugio."
const tos6LAdm_rb1 = "Mi heredad en el país de la vida."
const tos6LAdm_rb2 = "Tú eres mi refugio."
...
const tos1LAln_lbt = "2Ts 3, 10b-13"
const tos1LAln_lb = "Si alguno no quiere trabajar, que tampoco coma. Porque nos hemos enterado que hay entre vosotros algunos que viven desconcertados, sin trabajar nada, pero metiéndose en todo. A éstos les mandamos y les exhortamos en el Señor Jesucristo a que trabajen con sosiego para comer su propio pan. Vosotros, hermanos, no os canséis de hacer el bien."
const tos1LAln_rb = "Bendito el Señor ahora y por siempre."
const tos1LAln_rb1 = "Solo él hizo maravillas."
const tos1LAln_rb2 = "Ahora y por siempre."

// Himno Tiempo Ordinario, Semana 2 Laudes Lunes
const tos2LAln_lbt = "Jr 15, 16"
const tos2LAln_lb = "Cuando encontraba palabras tuyas las devoraba; tus palabras eran mi gozo y la alegría de mi corazón, porque tu nombre fue pronunciado sobre mí, ¡Señor, Dios de los ejércitos!"
const tos2LAln_rb = "Aclamad, justos, al Señor, que merece la alabanza de los buenos."
const tos2LAln_rb1 = "Cantadle un cántico nuevo."
const tos2LAln_rb2 = "Que merece la alabanza de los buenos."

// Himno Tiempo Ordinario, Semana 3 Laudes Lunes
const tos3LAln_lbt = "St 2, 12-13"
const tos3LAln_lb = "Hablad y actuad como quienes han de ser juzgados por una ley de libertad. Pues habrá un juicio sin misericordia para quien no practicó misericordia; pero la misericordia triunfa sobre el juicio."
const tos3LAln_rb = "Bendito el Señor ahora y por siempre."
const tos3LAln_rb1 = "Solo él hizo maravillas."
const tos3LAln_rb2 = "Ahora y por siempre."

// Himno Tiempo Ordinario, Semana 4 Laudes Lunes
const tos4LAln_lbt = "Jdt 8, 21b-23"
const tos4LAln_lb = "Recordad que Dios ha querido probarnos como a nuestros padres. Recordad lo que hizo con Abraham, las pruebas por que hizo pasar a Isaac, lo que aconteció a Jacob. Como les puso a ellos en el crisol para sondear sus corazones, así el Señor nos hiere a nosotros, los que nos acercamos a él, no para castigarnos, sino para amonestarnos."
const tos4LAln_rb = "Aclamad, justos, al Señor, que merece la alabanza de los buenos."
...
// SABADO
const tos1LAsb_lbt = "2Pe 1, 10-11"
const tos1LAsb_lb = "Hermanos, poned más empeño todavía en consolidar vuestra vocación y elección. Si hacéis así, nunca jamás tropezaréis; de este modo se os concederá generosamente la entrada en el reino eterno de nuestro Señor y salvador Jesucristo."
const tos1LAsb_rb = "A ti grito, Señor, tú eres mi refugio."
const tos1LAsb_rb1 = "Mi heredad en el país de la vida."
const tos1LAsb_rb2 = "Tú eres mi refugio."

const tos2LAsb_lbt = "Rm 12, 14-16a"
const tos2LAsb_lb = "Bendecid a los que os persiguen, no maldigáis. Alegraos con los que se alegran; llorad con los que lloran. Tened un mismo sentir entre vosotros, sin apetecer grandezas; atraídos más bien por lo humilde."
const tos2LAsb_rb = "Te aclamarán mis labios, Señor, cuando salmodie para ti."
const tos2LAsb_rb1 = "Mi lengua recitará tu auxilio."
const tos2LAsb_rb2 = "Cuando salmodie para ti."

const tos3LAsb_lbt = "Flp 2, 14-15"
const tos3LAsb_lb = "Hacedlo todo sin murmuraciones ni discusiones, a fin de que seáis irreprensibles y sencillos, hijos de Dios sin mancha, en medio de esta generación mala y perversa, entre la cual aparecéis como antorchas en el mundo."
const tos3LAsb_rb = "A ti grito, Señor, tú eres mi refugio."
const tos3LAsb_rb1 = "Mi heredad en el país de la vida."
const tos3LAsb_rb2 = "Tú eres mi refugio."

const tos4LAsb_lbt = "2 Pe 3, 13-15a"
const tos4LAsb_lb = "Nosotros conforme a la promesa del Señor esperamos cielos nuevos y tierra nueva, en los que tiene su morada la santidad. Por eso, carísimos, mientras esperáis estos acontecimientos, procurad con toda diligencia que él os encuentre en paz, sin mancha e irreprensibles. Considerad esta paciente espera de nuestro Señor como una oportunidad para alcanzar la salud."
const tos4LAsb_rb = "Te aclamarán mis labios, Señor, cuando salmodie para ti."
const tos4LAsb_rb1 = "Mi lengua recitará tu auxilio."
const tos4LAsb_rb2 = "Cuando salmodie para ti."