...
${ "" /* REPRODUCTOR AUTOMÁTICO ENCADENADO */ }
        <div class="audio-container" style="margin-top: 20px; padding: 15px; background: rgba(255,0,0,0.05); border-radius: 8px;">
            <p class="rubrica" style="font-size: 14px; margin-bottom: 10px;">REPRODUCCIÓN CONTINUA</p>
            
            <div style="margin-bottom: 10px;">
                <small class="rubrica" style="font-size: 11px;">1. Lectura del Ciclo</small>
            ...
            <div>
                <small class="rubrica" style="font-size: 11px;">2. Lecturas Varias</small>
                <audio id="audio2" controls style="width: 100%;">
...
// Agrega esto dentro de tu función renderizarLaudes, justo después de contenedor.innerHTML = ...
const a1 = document.getElementById('audio1');
const a2 = document.getElementById('audio2');

if (a1 && a2) {
    a1.onended = function() {
        console.log("%c ⏭️ Primer audio terminado. Iniciando segundo...", "color: green; font-weight: bold;");
        a2.play();
        // Opcional: Hacer scroll automático al segundo reproductor
